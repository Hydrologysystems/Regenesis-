...
const VIDEOS: VideoItem[] = [
  {
    id: 'v1',
    eyebrow: 'START HERE',
    title: 'Who Is Thomas Ventura?',
    subline: 'From a war-zone refugee to multi-million operator — and why none of it fixed the real problem.',
    category: 'KEYNOTE HIGHLIGHT',
    duration: '04:15',
    description: 'From a war-zone refugee to multi-million operator — and why none of it fixed the real problem.',
