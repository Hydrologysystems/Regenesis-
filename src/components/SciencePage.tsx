...
export const SciencePage: React.FC<SciencePageProps> = ({ 
  ...
  return (
    <div className="relative min-h-screen bg-[#0C0B0A] text-[#E8E3D5] font-inter overflow-hidden pb-24 pt-28">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16">
        <ScrollReveal yOffset={24}>
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="font-playfair italic text-lg sm:text-xl text-[#FCE289]">
        ...
        <div className="space-y-16">
          {SCIENCE_BLOCKS.map((block, blockIdx) => (
            <ScrollReveal key={block.number} delay={blockIdx * 0.1} yOffset={20}>
              <div className="bg-[#12100E]/90 border border-[#C9A227]/30 rounded-3xl p-6 sm:p-10 relative overflow-hidden backdrop-blur-md shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-[#C9A227]/20 pb-6 mb-8 gap-4">
                  ...
                  <p className="font-playfair italic text-base sm:text-lg text-[#FCE289] max-w-md">
                    {block.subtitle}
                  </p>
                </div>
                  ...
                  {block.lenses.map((lens, lensIdx) => {
                    ...
                    return (
                      <div
                        ...
                        className="group bg-[#1A1612]/90 border border-[#C9A227]/30 hover:border-[#C9A227] rounded-2xl p-6 transition-all duration-300 cursor-pointer flex flex-col justify-between hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(201,162,39,0.18)]"
                      >
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="w-9 h-9 rounded-xl bg-[#C9A227]/10 border border-[#C9A227]/30 flex items-center justify-center text-[#C9A227] group-hover:bg-[#C9A227] group-hover:text-black transition-colors">
                              <IconComponent className="w-4 h-4" />
                            </div>
                          </div>

                          <h4 className="font-sans font-black text-base sm:text-lg text-white uppercase tracking-tight group-hover:text-[#FCE289] transition-colors">
                            {lens.name}
                          </h4>
                          ...
                          <p className="font-inter text-xs text-[#D4CEBF] leading-relaxed line-clamp-3">
                            {lens.description}
                          </p>
                        </div>

                        <div className="pt-4 mt-4 border-t border-[#C9A227]/20 flex items-center justify-between text-xs font-mono text-[#C9A227] group-hover:text-white transition-colors">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16">
        <ScrollReveal yOffset={24}>
          <div className="bg-[#100E0C] border border-[#C9A227]/40 rounded-3xl p-8 sm:p-12 space-y-8 relative overflow-hidden backdrop-blur-md shadow-2xl">
            <div className="border-b border-[#C9A227]/30 pb-6 space-y-2">
              <span className="font-mono text-xs font-bold text-[#C9A227] tracking-[0.25em] uppercase block">
                SECTION 3
              </span>
            ...
            <div className="space-y-6 font-inter text-sm sm:text-base text-[#D4CEBF] leading-relaxed">
              <p>
                Most systems that explain people are built on one discipline. <strong className="text-white">MBTI</strong> came out of Jungian typology. <strong className="text-white">DISC</strong> came out of behavioral psychology. The <strong className="text-white">Enneagram</strong> came out of a spiritual and personality tradition. The <strong className="text-white">Big Five</strong> came out of statistical analysis of language.
              </p>
              <p>
                Each of those is a real lens. Each one is partial. A framework built on a single discipline can only see what that discipline is equipped to see — which is why most personality systems can tell you <strong className="text-[#FCE289]">what you do</strong> without ever explaining <strong className="text-white">why it costs you what it costs</strong>.
              </p>
              <p>
            ...
            <div className="p-6 rounded-2xl bg-[#1C1813] border-l-4 border-[#C9A227] shadow-lg">
              <p className="font-playfair italic font-bold text-lg sm:text-xl text-[#FCE289] text-center">
                One lens describes you. Twelve explain you.
              </p>
            </div>
          </div>
        </ScrollReveal>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-10">
        <ScrollReveal yOffset={24}>
          <div className="bg-[#12100E] border border-[#C9A227]/30 rounded-3xl p-8 sm:p-12 space-y-6 backdrop-blur-md shadow-2xl">
            <div className="border-b border-[#C9A227]/20 pb-4 space-y-1">
              ...
              <h2 className="font-sans font-black text-2xl sm:text-3xl text-[#FFFFFF] uppercase tracking-tight">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-10">
        <ScrollReveal yOffset={24}>
          <div className="bg-gradient-to-b from-[#181410] to-[#0E0C0A] border-2 border-[#C9A227]/50 rounded-3xl p-8 sm:p-12 space-y-6 shadow-[0_0_50px_rgba(201,162,39,0.15)] relative overflow-hidden">
            
            <div className="flex items-center gap-3 border-b border-[#C9A227]/30 pb-4">
            ...
            <div className="space-y-5 font-inter text-sm sm:text-base text-[#D4CEBF] leading-relaxed">
              <p>
              ...
              <p className="font-semibold text-[#FCE289] text-base sm:text-lg pt-2">
      ...
      {/* ================= SECTION 6 — CLOSE & CTA ================= */}
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16 pb-8 text-center">
        <ScrollReveal yOffset={24}>
          <div className="bg-[#120F0C] border-2 border-[#C9A227] rounded-3xl p-8 sm:p-14 space-y-8 shadow-[0_0_60px_rgba(201,162,39,0.25)] relative overflow-hidden">
