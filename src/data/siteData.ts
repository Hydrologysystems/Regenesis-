...
export const BOOKS_DATA: BookInfo[] = [
  {
    ...
    tagline: 'Awareness & Origin: decoding the survival hardware written in your earliest years — the code shaping your behavior, identity, and drive today.',
    description: 'Awareness & Origin: decoding the survival hardware written in your earliest years — the code shaping your behavior, identity, and drive today.',
    chapters: [
      'Awareness & Origin',
  ...
  },
  {
    ...
    tagline: 'Interruption & Rewrite: the protocol for interrupting survival conditioning and reconfiguring the patterns silently capping your capacity.',
    description: 'Interruption & Rewrite: the protocol for interrupting survival conditioning and reconfiguring the patterns silently capping your capacity.',
    chapters: [
  ...
  },
  {
    ...
    subtitle: 'Embodiment',
    tagline: 'Embodiment: the 365-day blueprint for living the new configuration, making it your default — and becoming The ONE.',
    description: 'Embodiment: the 365-day blueprint for living the new configuration, making it your default — and becoming The ONE.',
    chapters: [
      'Embodiment & Scaling',
...
export const AUDIENCE_PROFILES = [
  ...
  },
  {
    ...
    description: '"The one who can\'t let go." Leaders who intellectually know they need to delegate, but whose nervous system codes "trust" as "danger." This is for operators whose need for control is silently capping their team from stepping up.'
  },
  {
